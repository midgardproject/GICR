...
namespace GICR {
	 ...
	 * Note that the characteristics of the session created from the GuestCredentials remain implementation specific.  
	 */
	public class GuestCredentials : GLib.Object, Credentials {
