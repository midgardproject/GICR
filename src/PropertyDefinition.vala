...
namespace GICR {
	 ...
	 */
	public interface PropertyDefinition : Object, ItemDefinition {
		 ...
		 * {@link PropertyDefinitionTemplate}, then this method will return PropertyType.STRING.
		 *
		 * @return An integer constant member of PropertyType.
		 */
		public abstract int get_required_type ();
		 ...
		 * PropertyDefinition.get_value_constraints() call.
		 *
		 ...
		 * registration, the value returned by PropertyDefinition.get_value_constraints()
		 ...
		 * In implementations that support node type registration, if this
		 * PropertyDefinition object is actually a newly-created empty
		 * {@link PropertyDefinitionTemplate}, then this method will return null.
		 *
		 * @return a String array.
		 */
		public abstract string[] get_value_constraints ();
		 ...
		 * ItemDefinition.is_auto_created() returns true).
		 ...
		 * @return array values.
		 */
		public abstract ValueArray get_default_values ();

		/**
		 * Reports whether this property can have multiple values.
		 *
		 * Note that the isMultiple flag is special in that a given node
		 ...
		 * In implementations that support node type registration, if this
		 * PropertyDefinition object is actually a newly-created empty
		 * {@link PropertyDefinitionTemplate}, then this method will return false.
		 *
		 * @return True, if this property may have multiple values, else false.
		 */
		 ...
		 */
		public abstract string[] get_available_query_operators ();
		 ...
		 *
		 * @return True, if this property is full-text searchable, else false.
		 */
		public abstract bool is_full_text_searchable ();
		 ...
		 * property definition has a queryable setting of true.
		 *
		 * @return True, if this property is query orderable, else false.
		 */
		public abstract bool is_query_orderable ();
	}
}
