...
namespace GICR {
	...
	public interface LockManager : Object {
		 ...
		 *
		 * @param lockToekn A lock token string.
		 * @return void
		 *
		 ...
		 * @return The applicable {@link Lock} object.
		 *
		 ...
		 *                                 some other reason.
		 * @param integer timeoutHint Desired lock timeout in seconds 
		 ...
		 *
		 * @throws LockException if this node is not mix:lockable or this node is already locked or isDeep
		 ...
		 * @return void
		 *
		 * @throws LockException If this node does not currently hold a lock or holds a lock for which
